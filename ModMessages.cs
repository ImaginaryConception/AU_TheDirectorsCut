...
namespace AU_TheDirectorsCut
{
    public static class ModMessages
    {
        ...
        public const string HelpCutPlain = "/cut - 1,2,3 Soleil! Immobilisez-vous! Durée 5s - Cooldown 30s";

        public const string HelpSwap = "<color=#ffd23f>/swap</color> - Échange positions de 2 joueurs. IDs avec /players! Cooldown 15s";
        public const string HelpSwapPlain = "/swap - Échange positions de 2 joueurs. IDs avec /players! Cooldown 15s";
