...
namespace AU_TheDirectorsCut
{
    public static class ModMessages
    {
        ...
        public const string HelpBlindPlain = "/blind - Réduit vision d'un joueur pendant huit s! Cooldown vingt-cinq s";

        public const string HelpDarkness = "<color=#ffd23f>/darkness</color> - Obscurité TOTALE 10s! Cooldown 35s";
        public const string HelpDarknessPlain = "/darkness - Obscurité TOTALE dix s! Cooldown trente-cinq s";

        public const string HelpFreeze = "<color=#ffd23f>/freeze</color> - Immobilise un joueur 8s! Cooldown 30s";
        public const string HelpFreezePlain = "/freeze - Immobilise un joueur huit s! Cooldown trente s";

        public const string HelpSpin = "<color=#ffd23f>/spin</color> - Fait tourner un joueur 5s! Cooldown 20s";
        public const string HelpSpinPlain = "/spin - Fait tourner un joueur cinq s! Cooldown vingt s";

        public const string HelpRandomColors = "<color=#ffd23f>/randomcolors</color> - Couleurs aléatoires pour TOUS! Cooldown 20s";
        public const string HelpRandomColorsPlain = "/randomcolors - Couleurs aléatoires pour TOUS! Cooldown vingt s";

        public const string HelpShuffle = "<color=#ffd23f>/shuffle</color> - Mélange toutes les positions! Cooldown 25s";
        public const string HelpShufflePlain = "/shuffle - Mélange toutes les positions! Cooldown vingt-cinq s";

        public const string HelpTeleportAll = "<color=#ffd23f>/teleportall</color> - Téléporte TOUS vers un joueur! Cooldown 20s";
        public const string HelpTeleportAllPlain = "/teleportall - Téléporte TOUS vers un joueur! Cooldown vingt s";
        ...
        public const string CutStartPlain = "CUT ! Immobilisez-vous dans deux s !";
        ...
        public const string BlindSuccessPlain = "Vision réduite pour {0} (huit s) !";

        public const string FreezeSuccess = "{0} est gelé (8s) !";
        public const string FreezeSuccessPlain = "{0} est gelé (huit s) !";
        ...
        public const string SpinSuccessPlain = "{0} tourne en rond (cinq s) !";
